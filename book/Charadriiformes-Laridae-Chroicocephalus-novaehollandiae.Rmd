```{r, include=FALSE}
species.name <- 'Chroicocephalus novaehollandiae'
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.cap = 'insert figure caption', fig.width=8, fig.height=4.5, fig.align='centre'}
species.DATA$make_species_map(species.name, grid=grid.PLY)
```
...
```{r, echo=FALSE, message=FALSE, warning=FALSE, results='asis', fig.cap ='insert figure caption', fig.width=8, fig.height=2.5}
